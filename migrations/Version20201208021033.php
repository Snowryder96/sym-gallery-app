 ...
 */
final class Version20201208021033 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE painting CHANGE technic_id technic_id INT DEFAULT NULL, CHANGE category_id category_id INT NOT NULL');
