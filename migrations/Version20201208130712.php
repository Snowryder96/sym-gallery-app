 ...
 */
final class Version20201208130712 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE painting ADD CONSTRAINT FK_66B9EBA012469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE painting ADD CONSTRAINT FK_66B9EBA0FAAE137C FOREIGN KEY (technic_id) REFERENCES technic (id) ON DELETE SET NULL');
